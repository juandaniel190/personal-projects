...
description: Deep dives into ICP construction, multi-source workflows, Apollo + Clay templates, firmographics, technographics, and contact enrichment. Use when building prospect lists or defining ICPs.
---
...
See [outbound-list-building-directories.md](outbound-list-building-directories.md) for curated industry-specific directories.

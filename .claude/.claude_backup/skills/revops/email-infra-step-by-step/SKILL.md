---
name: email-infra-step-by-step
description: "Step-by-step walkthroughs for cold email infra: sizing, domains, Google/Microsoft setup, DNS (SPF/DKIM/DMARC), Instantly, warm-up, going live. Use when implementing or troubleshooting email infra."
---

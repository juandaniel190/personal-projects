...
description: >
  Use when diagnosing dbt Cloud or platform job failures. Classifies errors as
  Infrastructure, Code/Compilation, or Data/Test issues and provides investigation
  and resolution workflows using MCP tools and CLI.
---

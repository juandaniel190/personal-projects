...
description: >
  Use when fetching, searching, or referencing dbt documentation. Covers LLM-friendly
  URL patterns, page index, llms.txt fast search, and a bash script for full-text

...
description: >
  Use when migrating a dbt project from dbt Core to the Fusion engine. Covers
  dbt-autofix for package updates and deprecations, manual fixes for custom configs
  and dynamic SQL, and documentation of changes.
---

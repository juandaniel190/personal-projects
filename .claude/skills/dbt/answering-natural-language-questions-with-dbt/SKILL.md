...
description: >
  Use when answering business questions using dbt data. Covers four approaches:
  semantic layer query, modified compiled SQL, model discovery, and manifest/catalog
  analysis, plus suggestions for semantic layer improvements.
---

...
description: >
  Use when migrating a dbt project from one data platform to another. Uses dbt
  Fusion as the migration tool with unit test generation on the source platform
  and validation on the target.
---

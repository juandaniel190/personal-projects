...
description: >
  Use when writing unit tests for dbt models. Covers YAML specification, mock data
  formats (dict, csv, sql), incremental/ephemeral/versioned model special cases,
  and warehouse-specific data type caveats.
---

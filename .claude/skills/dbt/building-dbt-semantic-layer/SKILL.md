...
description: >
  Use when creating or editing dbt semantic layer components — metrics, dimensions,
  and entities. Handles both latest spec (dbt Core 1.12+ / Fusion) and legacy spec
  (dbt Core 1.6–1.11), with validation and common pitfalls.
---

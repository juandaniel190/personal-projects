...
description: >
  Use when building, modifying, or debugging dbt models and analytics pipelines.
  Covers DAG design, data discovery, testing, documentation, package management,
  cost management, and common mistakes.
---

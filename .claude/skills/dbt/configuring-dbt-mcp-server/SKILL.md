...
description: >
  Use when setting up or configuring the dbt MCP server for local or remote use.
  Covers prerequisites, credential setup, and client-specific configuration for

---
name: clay-operations-guide
description: "Use Clay effectively: data providers, credit management, GTM workflows. Use when setting up Clay, choosing providers, or building outbound workflows."
---
...
For the full template library, see [outbound-clay-operations-templates.md](outbound-clay-operations-templates.md).
For credit optimization deep dive, see [outbound-clay-operations-credit-optimization.md](outbound-clay-operations-credit-optimization.md).

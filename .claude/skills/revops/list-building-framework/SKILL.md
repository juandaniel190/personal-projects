...
description: Build B2B prospect lists using multi-source strategies, ICP definition, Clay enrichment, and data validation. Use when building lead lists, defining ICPs, or planning outbound data strategy.
---
...
For detailed walkthroughs of each phase, see [outbound-list-building-deep-dives.md](outbound-list-building-deep-dives.md).
For industry-specific directories to scrape, see [outbound-list-building-directories.md](outbound-list-building-directories.md).
For the full 62 data sources table, see [outbound-list-building-data-sources.md](outbound-list-building-data-sources.md).
...
For the full ICP deep dive (how to build, examples, common mistakes), see [outbound-list-building-deep-dives.md](outbound-list-building-deep-dives.md).
...
- See [outbound-list-building-directories.md](outbound-list-building-directories.md) for industry-specific sources

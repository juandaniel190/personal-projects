---
name: cold-email-infra-guide
description: "Plan, build, and maintain cold email sending infrastructure: sizing, domains, workspaces, DNS, Instantly, warm-up, monitoring. Use when setting up or troubleshooting cold email infra."
---
...
For detailed walkthroughs of each step, see [outbound-email-infra-step-by-step.md](outbound-email-infra-step-by-step.md).
For DNS issues and deliverability problems, see [outbound-email-infra-troubleshooting.md](outbound-email-infra-troubleshooting.md).
...
For DNS troubleshooting, see [outbound-email-infra-troubleshooting.md](outbound-email-infra-troubleshooting.md).
...
For detailed recovery protocols, see [outbound-email-infra-troubleshooting.md](outbound-email-infra-troubleshooting.md).

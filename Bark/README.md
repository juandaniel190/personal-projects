...
**Live Demo**
- 📊 [Interactive Deck](https://damezquita.github.io/personal-projects/Bark/Bark_Trading_Diagnostic.html)
- 📄 [Print Version](https://damezquita.github.io/personal-projects/Bark/Bark_Trading_Diagnostic_Print.html)
...
- Read the full written analysis in `Bark_Trading_Diagnostic.md`.
